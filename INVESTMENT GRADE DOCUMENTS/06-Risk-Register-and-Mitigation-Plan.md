...
|---|---|---|---|---|---|
| R6 | Security crisis in NW/SW and Far North regions prevents school-level rollout there | 4 | 3 | 12 | Region-phased rollout puts affected regions in the final wave; batch-level (not per-copy) tracking mode reduces field workload; division-level operation where school access is unsafe |
