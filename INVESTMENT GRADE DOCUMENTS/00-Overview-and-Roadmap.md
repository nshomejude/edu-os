...
| [09](09-Technology-Stack-and-Architecture-Decisions.md) | Tech Stack & Architecture Decisions | ADR-format decisions: modular monolith with DDD bounded contexts, PostgreSQL/Laravel/Flutter open-source stack, API-first with APIs as national digital public infrastructure — and what was deliberately rejected |
