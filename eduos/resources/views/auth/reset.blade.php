...
<div class="login-wrap"><div class="login-card">
    ...
    <h1 style="text-align:center;font-size:22px;margin-bottom:20px;">Choose a new password</h1>
    ...
    <form method="post" action="{{ route('password.update') }}">@csrf
        ...
        <div class="field" style="margin-bottom:14px"><label>Email</label><input class="input" type="email" name="email" value="{{ $email }}" required></div>
        ...
        <div class="field" style="margin-bottom:18px"><label>Confirm</label><input class="input" type="password" name="password_confirmation" required></div>
        <button class="btn btn-primary" style="width:100%;justify-content:center;">Reset password</button>
    </form>
</div></div>
</body></html>
